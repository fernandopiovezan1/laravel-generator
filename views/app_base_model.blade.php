...
//        }
     ...
     *
     */
    public function all(array $search = [], int|null $skip = null, int|null $limit = null, array $columns = ['*']): Builder|Collection
    {
     ...
     *
     */
    public function find(int|string $id, array $columns = ['*']): Builder|Collection|Model|null
    {
        $query = $this->newBaseQuery();
     ...
     *
     */
    public function findBy(array|string|\Closure $column, mixed $value, string $operator = '=', string $boolean = 'and'): Builder
    {
        $query = $this->newBaseQuery();
